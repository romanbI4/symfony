...
final class Version20220531193734 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, authors TEXT NOT NULL, date VARCHAR(255) NOT NULL, boolean BOOLEAN DEFAULT \'false\' NOT NULL, PRIMARY KEY(id))');
